...
public class Favourites extends RealmObject {
    ...
    public Favourites(String name, String category, String subCategory, RealmList<Org> orgs, RealmList<Coordinator> coordinators, String description, int teamSize, int participationFee) {
        this.name = name;
